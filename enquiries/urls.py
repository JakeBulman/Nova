...
urlpatterns = [
    ...
    path('task_manager/reload_tolerance', views.reload_tolerance_view, name='reload-tolerance'),
    path('task_manager/reload_tolerance_complete', views.reload_tolerance, name='reload-tolerance-complete'),
    path('task_manager/request_mis', views.request_mis, name='request-mis'),
