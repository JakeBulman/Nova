...
class DjangoStagingTableAPP(models.Model):
    ...
    enquiry_id = models.ForeignKey(CentreEnquiryRequests, to_field='enquiry_id', on_delete=models.SET_NULL, null=True, related_name='staging_enquiry_id')
    eps_creation_date = models.DateTimeField(null=True)
    eps_ses_sid = models.CharField(max_length=8, null=True)
    eps_centre_id = models.CharField(max_length=5, null=True)
    eps_ass_code = models.CharField(max_length=4, null=True)
    eps_ass_ver_no = models.CharField(max_length=4, null=True)
    com_id = models.CharField(max_length=2, null=True)
    me_id = models.CharField(max_length=5, null=True)
...
class DjangoStagingTableMAR(models.Model):
    ...
    eps_centre_id = models.CharField(max_length=5, null=True)
    eps_cand_id = models.CharField(max_length=8, null=True)
    scaled_mark = models.CharField(max_length=7, null=True)
    final_mark = models.CharField(max_length=7, null=True)
    selected_justification_code = models.CharField(max_length=1, null=True) 
    mark_confirmed_ind = models.CharField(max_length=1, null=True)
    copied_to_est = models.IntegerField(default=0)
