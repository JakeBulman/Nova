# Generated by Django 4.1.3 on 2024-08-07 15:11
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('enquiries', '0100_alter_casecomments_case_pk'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cer_sid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='enquiry_special_marks', to='enquiries.centreenquiryrequests', to_field='enquiry_id')),
                ('ec_sid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='script_special_marks', to='enquiries.enquirycomponents', to_field='ec_sid')),
            ],
        ),
    ]
