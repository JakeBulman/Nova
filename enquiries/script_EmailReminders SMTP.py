...
email["To"] = "results.enquiries@cambridge.org, jacob.bulman@cambridge.org, sarah.endersby@cambridge.org"
...
smtp = smtplib.SMTP("smtp0.ucles.internal", port=25) 
smtp.sendmail(sender, ["results.enquiries@cambridge.org", "jacob.bulman@cambridge.org", "sarah.endersby@cambridge.org"], email.as_string())
smtp.quit()
