...
STORAGES = {
    "default": {
        "BACKEND" : "redepplan.storage_backends_dev.PublicMediaStorage",
    },

    "staticfiles":  {
        "BACKEND" : "redepplan.storage_backends_dev.StaticStorage",
    },
}
# s3 static settings
STATIC_LOCATION = 'DEV/static'
...
PUBLIC_MEDIA_LOCATION = 'DEV/media'
